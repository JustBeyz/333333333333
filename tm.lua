...
local ThemeManager = {} do
	local ThemeFields = { "FontColor", "MainColor", "AccentColor", "BackgroundColor", "OutlineColor", "Inline", "VideoLink" }
	ThemeManager.Folder = "LinoriaLibSettings"
	-- if not isfolder(ThemeManager.Folder) then makefolder(ThemeManager.Folder) end

	ThemeManager.Library = nil
	ThemeManager.BuiltInThemes = {
		['Default']                             = { 1, { FontColor = "ffffff", MainColor = "151515", AccentColor = "85bb65", BackgroundColor = "151515", OutlineColor = "272727", Inline = "000000" } },
		['Linoria']                             = { 2, { FontColor = "ffffff", MainColor = "1c1c1c", AccentColor = "0055ff", BackgroundColor = "141414", OutlineColor = "323232", Inline = "000000" } },
		['Fatality']                            = { 3, { FontColor = "ffffff", MainColor = "1e1842", AccentColor = "c50754", BackgroundColor = "191335", OutlineColor = "3c355d", Inline = "000000" } },
		['Gold']                                = { 7, { FontColor = "fff8dc", MainColor = "3a3020", AccentColor = "e5ae32", BackgroundColor = "241d13", OutlineColor = "6b5427", Inline = "100c06" } },
		['McDonalds']                           = { 8, { FontColor = "fffbea", MainColor = "d71920", AccentColor = "ffcc00", BackgroundColor = "9f1117", OutlineColor = "ffea70", Inline = "5c080c" } },
		['Midnight']                            = { 9, { FontColor = "e9f4ff", MainColor = "172b48", AccentColor = "4aa3ff", BackgroundColor = "0b172b", OutlineColor = "2d4d78", Inline = "050b16" } },
	}
	...
	function ThemeManager:ThemeUpdate()
		...
		self.Library.Black = self.Library.Inline or self.Library.Black;
	...
	function ThemeManager:CreateThemeManager(groupbox)
		...
		groupbox:AddLabel('Inline color')	:AddColorPicker('Inline', { Default = self.Library.Inline or self.Library.Black });
		groupbox:AddLabel('Font color')	:AddColorPicker('FontColor', { Default = self.Library.FontColor });
		groupbox:AddToggle('ThemeManager_Glow', {
			Text = 'glow',
			Default = self.Library.GlowEnabled == true,
			Callback = function(value)
				if self.Library.SetGlowEnabled then
					self.Library:SetGlowEnabled(value)
				end
			end,
		});
		groupbox:AddSlider('ThemeManager_GlowIntensity', {
			Text = 'glow intensity',
			Min = 0,
			Max = 100,
			Default = (self.Library.GlowIntensity or 0.35) * 100,
			Rounding = 0,
			Suffix = '%',
			Callback = function(value)
				if self.Library.SetGlowIntensity then
					self.Library:SetGlowIntensity(value / 100)
				end
			end,
		});
		...
		self.Library.Options.Inline:OnChanged(UpdateTheme)
